  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <select onChange={e => setCategory(e.target.validationMessage)} className='mt-2 px-3 py-2 border text-gray-500 border-gray-300 outline-none rounded' name='category'>
        ...
        <button type="submit" class="mt-8 w-40 h-10 bg-primary text-white rounded cursor-pointer text-sm">Add Blog</button>
      </div>
    </form>
  )
}
